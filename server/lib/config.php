...
$config = [
    ...
    'live' => [
        'capture_interval_ms' => max(400, $envInt('APP_LIVE_CAPTURE_INTERVAL_MS', 1000)),
        'status_interval_ms' => max(300, $envInt('APP_LIVE_STATUS_INTERVAL_MS', 650)),
        ...
        'agent_poll_probe_ms' => max(25, min(1000, $envInt('APP_AGENT_POLL_PROBE_MS', 60))),
        ...
        'agent_poll_idle_ms' => max(100, min(5000, $envInt('APP_AGENT_POLL_IDLE_MS', 350))),
        'agent_poll_eco_ms' => max(40, min(2000, $envInt('APP_AGENT_POLL_ECO_MS', 120))),
        'agent_poll_flow_ms' => max(15, min(1000, $envInt('APP_AGENT_POLL_FLOW_MS', 45))),
        'agent_poll_burst_ms' => max(8, min(500, $envInt('APP_AGENT_POLL_BURST_MS', 15))),
        'pointer_batch_ms' => max(12, min(250, $envInt('APP_POINTER_BATCH_MS', 24))),
